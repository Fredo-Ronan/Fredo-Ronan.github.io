...
//==========================================================================================================================//
//handle the 'upcoming' text animation
const upcomingText = document.getElementById('upcoming-text');

//to give the hover simulation class for the first page loaded and then remove it after 3 second using setTimeout()
upcomingText.classList.toggle('hover-simulation');
setTimeout(() => {
    upcomingText.classList.toggle('hover-simulation')
}, 3000);

const toggleDarkMode = document.querySelector('input[name=toggle-dark-btn]');
