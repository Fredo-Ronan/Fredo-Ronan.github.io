...
function generateProjectContent(rootElement, projectTitle, projectDetailDescription, imagePosition, imageLink, svgPictures, linkToProject){
    ...
    h3ProjectTitle.innerHTML = projectTitle; // fill the name from parameter
...
viewBox="0 0 285 285"
 ...
 <title>Flet Python New UI Framework</title>
 <g id="Layer_x0020_1">
...
generateProjectContent(
    ...
    `,
    'left',
    'assets/fredo_downloader_demo.png',
    arrayOfSvg,
    'https://github.com/Fredo-Ronan/Fredo_Downloader'
);